...
export function createInitialGame(): GameState {
  return { version: 11, page: 'town', gold: 100, roster: initialHeroes.map((hero) => ({ ...hero, equipment: { ...hero.equipment } })), inventory: { ...initialInventory }, selectedHeroIds: ['lan', 'wu', 'xingluo'], selectedMissionId: missions[0].id, managementTab: 'party', expedition: null, settings: { moraleEnabled: true, llmEnabled: true }, log: ['酒馆备好了远征委托，请先接取任务再从城门出发。'], materials: {}, hasAcceptedMission: false, day: 1, missionAcceptedToday: false, food: 5, hunger: 0, giftsGivenToday: {} };
}
