import type { CraftingRecipe, Enemy, Hero, HeroClass, ItemDefinition, MaterialType, Mission, Rarity } from '../domain/model';
...
export const rarityColors: Record<Rarity, string> = { 0: '#9ca3af', 1: '#4ade80', 2: '#60a5fa', 3: '#c084fc', 4: '#fbbf24' };
...
export const initialHeroes: Hero[] = [
  { id: 'lan', name: '岚', heroClass: 'vanguard', maxHp: 32, hp: 32, morale: 0, gearLevel: 0, level: 1, experience: 0, equipment: {}, recruited: true, personality: '谨慎可靠，不喜欢无谓冒险', affinity: 0, preferredGiftTags: ['文化', '贵重'] },
  { id: 'wu', name: '雾', heroClass: 'ranger', maxHp: 24, hp: 24, morale: 0, gearLevel: 0, level: 1, experience: 0, equipment: {}, recruited: true, personality: '敏锐健谈，总能先发现退路', affinity: 0, preferredGiftTags: ['饮食', '自然'] },
  { id: 'xingluo', name: '星罗', heroClass: 'mage', maxHp: 19, hp: 19, morale: 0, gearLevel: 0, level: 1, experience: 0, equipment: {}, recruited: true, personality: '面对未知时格外兴奋', affinity: 0, preferredGiftTags: ['神秘', '自然'] },
