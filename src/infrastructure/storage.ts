...
export function loadGame(): GameState | null { try { const raw = localStorage.getItem(KEY); if (!raw) return null; const state = JSON.parse(raw) as GameState; return state.version === 3 ? state : null; } catch { return null; } }
